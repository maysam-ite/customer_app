...
EventInfoService service=EventInfoService();
 EventInfoModel model=EventInfoModel(title: 'title', availablePlaces: 2, beginDate: DateTime(2003), id: 1, description: "description", ticketPrice: 2500, images: [], artist: [], bandName: "");
late int eventId;
  @override
  void onClose() {
